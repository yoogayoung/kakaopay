...
public class CollectControllerTest {
    ...
    @Test
    public void testPointCollect() throws Exception {
        HashMap<String, Object> param = new HashMap<>();
        param.put("barcode","7281013626"); //존재하는 바코드
        //param.put("barcode","728101"); //존재하지 않는 바코드
        //param.put("partnerId","3"); //존재하는 상점키
        param.put("partnerId","9"); //존재하지 않는 상점키
        param.put("point","100"); //적립금액

        String content = objectMapper.writeValueAsString(param);

        mvc.perform(MockMvcRequestBuilders.post("/collect/point")
                .content(content)
